...
object AppConfig {
    ...
    const val PREF_SIMPLE_MODE = "pref_simple_mode"
    ...
    const val APP_URL = "$GITHUB_URL/dagata1/KNcloud-Android"
    const val APP_API_URL = "https://api.github.com/repos/dagata1/KNcloud-Android/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/dagata1/KNcloud-Android/main/CR.md"
