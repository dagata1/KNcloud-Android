...
abstract class ResolvedPlugin(protected val resolveInfo: ResolveInfo) : Plugin() {
    ...
    override val label: CharSequence get() = resolveInfo.loadLabel(KNApplication.application.packageManager)
    override val icon: Drawable get() = resolveInfo.loadIcon(KNApplication.application.packageManager)
    ...
    fun getPackageInfo(packageName: String) = KNApplication.application.packageManager.getPackageInfo(
